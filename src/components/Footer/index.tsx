          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                Shop No. 224, 2nd Floor, DLF City Centre Mall, MG Road, Gurugram - 122002
              </li>

              <li>
                <a href={`mailto:${siteConfig.contactEmail}`} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <div aria-label="payment system with visa card">
                  <Image
                ...
                <div aria-label="payment system with master card">
                  <Image
                ...
                <div aria-label="payment system with google pay">
                  <Image
