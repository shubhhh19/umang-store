...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Lehngas", value: "1" },
    { label: "Readymade Suits", value: "2" },
    { label: "Fabric Suits", value: "3" },
  ];
                  ...
                  <div className="relative group">
                    <Link href="/my-account" className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-custom-sm text-dark max-w-[110px] truncate">
                          {session.user?.name || session.user?.email || "My Account"}
                        </p>
                      </div>
                    </Link>

                    <div className="absolute left-0 top-full pt-2 w-44 hidden group-hover:block z-50">
                      <div className="bg-white rounded-md shadow-lg border border-gray-3 py-2">
                        <Link
                          href="/my-account"
                          className="block px-4 py-2 text-custom-sm text-dark hover:bg-gray-1 hover:text-blue"
                        >
                          My Account
                        </Link>
                        <button
